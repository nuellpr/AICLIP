      ...
      <section className="relative px-5 pb-24 lg:px-8">
        <Reveal className="mx-auto max-w-5xl">
          <div className="gradient-border relative overflow-hidden rounded-[2rem] p-10 text-center sm:p-16">
            ...
            <div className="cf-blob-1 pointer-events-none absolute -top-24 -left-16 h-64 w-64 rounded-full bg-blue-500/20 blur-[90px]" aria-hidden="true" />
            <div className="cf-blob-2 pointer-events-none absolute -right-16 -bottom-24 h-72 w-72 rounded-full bg-purple-500/20 blur-[100px]" aria-hidden="true" />
            <div className="cf-blob-3 pointer-events-none absolute top-1/3 left-1/2 h-52 w-52 rounded-full bg-pink-500/15 blur-[80px]" aria-hidden="true" />
