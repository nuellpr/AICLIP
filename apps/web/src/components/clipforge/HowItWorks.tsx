...
const steps = [
  {
    ...
    mock: (
      <div className="rounded-xl bg-[#F8F7F4] p-3">
        <div className="flex items-center gap-2 rounded-lg bg-white px-3 py-2.5 text-xs text-[#6E6D7A] shadow-sm">
          <Link2 size={14} className="text-[#EA4C89]" />
          <span className="truncate">youtube.com/watch?v=9z…</span>
        </div>
        <div className="mt-2 flex items-center justify-between text-[10px] text-[#6E6D7A]">
    ...
    mock: (
      <div className="rounded-xl bg-[#F8F7F4] p-3">
        <div className="flex items-center justify-between text-[10px]">
          <span className="text-[#6E6D7A]">Mendeteksi momen…</span>
        ...
        <div className="mt-2.5 space-y-1.5">
          {[
            ...
            <div key={m.t} className="flex items-center justify-between rounded-lg bg-white px-2.5 py-1.5 text-[10px] shadow-sm">
              <span className="flex min-w-0 items-center gap-1.5 text-[#0D0C22]">
  ...
  },
  {
    ...
    mock: (
      <div className="rounded-xl bg-[#F8F7F4] p-3">
        <div className="flex items-center justify-between gap-2 rounded-lg bg-white px-3 py-2.5 shadow-sm">
          <div className="flex min-w-0 items-center gap-2">
            <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#DBF3E8] text-[#0D0C22]">
              <Download size={13} />
            </div>
            <div className="min-w-0">
              <div className="truncate text-[11px] font-medium text-[#0D0C22]">clip_01_9x16.mp4</div>
              <div className="text-[9px] text-[#6E6D7A]">1080p • Karaoke • 480 KB</div>
            </div>
          </div>
...
export default function HowItWorks() {
  return (
    <section id="cara-kerja" className="relative bg-[#F8F7F4] py-24 lg:py-32">
          ...
          {steps.map((s, i) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#E7E4F9] text-[#0D0C22]">
                  <s.icon size={21} />
                </div>
              </div>
              <h3 className="mt-4 text-lg font-bold text-[#0D0C22]">{s.title}</h3>
              <p className="mt-2 text-sm leading-relaxed text-[#6E6D7A]">{s.desc}</p>
