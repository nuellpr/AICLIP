...
import { ArrowRight, Scissors, Zap, Share2, Sparkles, CheckCircle2, Star, Flame, Trophy } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-[#060609]/70 backdrop-blur-xl">
        <div className="container mx-auto flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <Link href="/login" className="text-sm font-semibold text-gray-300 hover:text-white px-3 py-2 transition-colors">
              Masuk
            </Link>
            <Link href="/login" className="gradient-border group inline-block">
        ...
        <section className="relative pt-20 pb-28 lg:pt-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="mt-12 flex flex-col items-center justify-center gap-5 sm:flex-row">
              <Link href="/login" className="group flex items-center gap-3 rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 px-9 py-5 text-lg font-black text-black hover:opacity-95 transition-all shadow-[0_0_30px_rgba(6,182,212,0.5)] hover:scale-105">
        ...
        <section className="py-20 relative">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="glass-panel rounded-3xl p-12 text-center relative overflow-hidden border border-cyan-500/30">
              ...
              <div className="mt-10">
                <Link href="/login" className="inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-cyan-400 to-blue-600 px-9 py-5 text-lg font-black text-black hover:opacity-90 transition-all shadow-[0_0_30px_rgba(6,182,212,0.5)]">
