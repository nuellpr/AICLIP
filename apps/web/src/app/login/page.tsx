...
import { Sparkles, Mail, Lock, User as UserIcon, ArrowRight, ShieldCheck, AlertCircle } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    setError(null);
    try {
      // Simulate Google Auth token or dev mode prompt
      const sampleEmail = email || `user_${Date.now()}@gmail.com`;
      const sampleName = name || 'Google User';
